          ...
          {paymentDetails.transactionId && (
            <div className="space-y-2">
              <div className="text-sm">
                <span className="font-medium">ID Transaction:</span> {paymentDetails.transactionId}
              </div>
            </div>
          )}
          ...
          {paymentDetails.method && (
            <div className="text-sm">
              <span className="font-medium">Méthode:</span> {
                paymentDetails.method === 'CMI' ? 'Carte Bancaire (CMI)' : 
                paymentDetails.method === 'CASH_PLUS' ? 'Cash Plus' : 
                paymentDetails.method
              }
            </div>
          )}
