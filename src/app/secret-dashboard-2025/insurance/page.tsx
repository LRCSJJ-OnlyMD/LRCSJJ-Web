              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4 border-b pb-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-600">{selectedInsurance.athlete.club.name}</p>
                ...
                <div className="grid grid-cols-2 gap-6">
                      ...
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          ...
                          <p className={`font-semibold ${
                            selectedInsurance.isPaid ? 'text-green-600' : 'text-red-600'
                          }`}>
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-3">Informations de Saison</h4>
                    <div className="space-y-3">
                      <div>
                        <p className="text-sm text-gray-500">Saison</p>
                  ...
                  <TableBody>
                    {insurances.map((insurance) => (
                      <TableRow key={insurance.id}>
                        ...
                        <TableCell className="font-semibold">{insurance.amount.toLocaleString()} MAD</TableCell>
                        <TableCell>
                          <div className="flex items-center space-x-2">
                            {insurance.isPaid ? (
                              <>
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <span className="font-semibold">{stats.unpaid}</span>
                      </div>
                      <div className="flex items-center justify-between">
