          ...
          <TabsContent value="overview">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold text-blue-600">{stats.complianceRate.toFixed(1)}%</div>
                  <div className="text-sm text-gray-500">
                    Paiements effectués
                  </div>
                </CardContent>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold text-orange-600">{stats.athletesWithInsurance}</div>
                  <div className="text-sm text-gray-500">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-right">
                        ...
                        <div className="text-sm text-gray-500">{stats.paidAmount.toFixed(2)} MAD</div>
                      </div>
                    </div>
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-2">
                      ...
                      <div className="text-right">
                        ...
                        <div className="text-sm text-gray-500">{stats.unpaidAmount.toFixed(2)} MAD</div>
                      </div>
                    </div>
                  </div>
                </CardContent>
              ...
              <CardContent>
                ...
                {Object.keys(monthlyPayments).length === 0 && (
                  <div className="text-center py-8">
                    ...
                    <p className="text-gray-500">Aucun paiement enregistré pour {currentYear}</p>
                  </div>
                )}
              </CardContent>
            </Card>
