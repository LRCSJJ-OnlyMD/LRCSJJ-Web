              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4 border-b pb-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-2xl font-semibold text-gray-900">{selectedTeam.name}</h3>
                    <p className="text-gray-600 mt-1">Division {selectedTeam.division}</p>
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-3">Informations de l&apos;Équipe</h4>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="bg-green-50 rounded-lg p-4">
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            <p className="text-sm text-green-600">Clubs Représentés</p>
                ...
                {selectedTeam.members && selectedTeam.members.length > 0 && (
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-3">Répartition par Club</h4>
                    <div className="grid grid-cols-2 gap-3">
                      {Object.entries(
                        ...
                        <div key={clubName} className="bg-gray-50 rounded-lg p-3">
                          ...
                          <p className="text-sm text-gray-600">{count} membre(s)</p>
                        </div>
                      ))}
                    </div>
                  </div>
          ...
          <TabsContent value="overview">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold text-orange-600">{stats.withCaptains}</div>
                </CardContent>
              </Card>
            </div>
          </TabsContent>
              ...
              {Object.keys(teamsByDivision).length === 0 ? (
                <Card>
                  <CardContent className="text-center py-8">
                    <p className="text-gray-500">Aucune équipe par division</p>
                  </CardContent>
                </Card>
              ) : (
