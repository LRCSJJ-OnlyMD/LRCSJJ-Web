...
export default function SeasonsManagement() {
  ...
  const getSeasonStatus = (season: Season) => {
    ...
    if (now < start) return { label: 'À venir', color: 'text-blue-600', bg: 'bg-blue-50' }
    if (now > end) return { label: 'Terminée', color: 'text-gray-600', bg: 'bg-gray-50' }
    return { label: 'En cours', color: 'text-green-600', bg: 'bg-green-50' }
  }
    ...
    <div className="container mx-auto p-6 space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600 mt-2">Gérez les saisons de la ligue de Ju-Jitsu Casablanca-Settat</p>
        </div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4 border-b pb-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-2xl font-semibold text-gray-900">{selectedSeason.name}</h3>
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-3">Période de la Saison</h4>
                    ...
                    <div className="space-y-3">
                      <div className="bg-blue-50 rounded-lg p-4">
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            <p className="text-sm text-blue-600">Assurances</p>
                ...
                <div className="bg-gray-50 rounded-lg p-4">
                  <h4 className="font-semibold text-gray-900 mb-2">État de la Saison</h4>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-blue-600">{currentSeasons}</div>
            <p className="text-xs text-muted-foreground">
            ...
            <CardContent>
              {seasonsLoading ? (
                <div className="text-center py-8">
                  ...
                  <p className="mt-2 text-gray-600">Chargement des saisons...</p>
                </div>
            ...
            <CardContent>
              {seasons?.filter(s => s.isActive).length === 0 ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-600">Aucune saison active trouvée</p>
                </div>
              ) : (
            ...
            <CardContent>
              {seasons?.filter(s => !s.isActive).length === 0 ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-600">Aucune saison archivée</p>
                </div>
              ) : (
                <div className="space-y-3">
                  {seasons?.filter(s => !s.isActive).map((season) => {
