  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center space-x-2">
        ...
        <h1 className="text-2xl font-bold">Map Configuration</h1>
      </div>
            ...
            {currentConfig && (
              <div className="space-y-2">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-800">{currentConfig.zoom}</p>
                </div>
                {currentConfig.address && (
                  <div>
                    <Label className="text-sm font-medium text-gray-600">Address</Label>
                    <p className="text-sm text-gray-800">{currentConfig.address}</p>
                  </div>
                )}
                <div>
