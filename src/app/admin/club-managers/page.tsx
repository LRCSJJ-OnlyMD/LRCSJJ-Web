...
export default function AdminClubManagersPage() {
  ...
  const handleCreateManager = async () => {
    ...
    try {
      // TODO: Call the real API to create club manager using tRPC
      // const result = await trpc.clubManager.create.mutate({
      //   name: formData.name,
      ...
      toast.success(
        "Gestionnaire de club créé avec succès! Email avec identifiants envoyé à " +
          formData.email
      );
    } catch (error) {
