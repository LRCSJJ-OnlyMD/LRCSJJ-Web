...
export default function AthletesManagement() {
  ...
  const getBeltColor = (belt: string | null) => {
    switch (belt?.toUpperCase()) {
      case 'BLANCHE': return 'bg-muted text-foreground'
      case 'JAUNE': return 'bg-yellow-100 text-yellow-800'
      case 'ORANGE': return 'bg-orange-100 text-orange-800'
      case 'VERTE': return 'bg-accent/10 text-accent-foreground'
      case 'BLEUE': return 'bg-primary/10 text-primary-foreground'
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-6">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-muted-foreground mt-1">{selectedAthlete.club.name}</p>
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div>
                    <h4 className="font-semibold text-foreground mb-3">Informations Personnelles</h4>
                ...
                {/* Sports Information */}
                <div>
                  <h4 className="font-semibold text-foreground mb-3">Informations Sportives</h4>
                  <div className="grid grid-cols-3 gap-4">
                    <div className="bg-gray-50 rounded-lg p-4">
                      <p className="text-sm text-muted-foreground">Ceinture</p>
              ...
              <Table>
                <TableHeader>
                  <TableRow className="border-gray-200 dark:border-gray-700">
                    <TableHead className="text-foreground dark:text-gray-100 font-semibold">Photo</TableHead>
                    <TableHead className="text-foreground dark:text-gray-100 font-semibold">Nom complet</TableHead>
                    <TableHead className="text-foreground dark:text-gray-100 font-semibold">Club</TableHead>
                    <TableHead className="text-foreground dark:text-gray-100 font-semibold">Ceinture</TableHead>
                    <TableHead className="text-foreground dark:text-gray-100 font-semibold">Poids</TableHead>
                    <TableHead className="text-foreground dark:text-gray-100 font-semibold">Contact</TableHead>
                    <TableHead className="text-foreground dark:text-gray-100 font-semibold">Actions</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
                  {athletes.map((athlete, index) => (
                    ...
                    <TableCell>
                      <div className="w-12 h-12 rounded-full overflow-hidden bg-muted flex items-center justify-center shadow-md">
                        {athlete.photoUrl ? (
                          ...
                          <User className="h-6 w-6 text-muted-foreground dark:text-muted-foreground" />
                        )}
                      </div>
                    </TableCell>
                    <TableCell>
                      <div>
                        ...
                        {athlete.nationalId && (
                          <div className="text-sm text-muted-foreground dark:text-muted-foreground">CIN: {athlete.nationalId}</div>
                        )}
                      </div>
                    </TableCell>
                    <TableCell>
                      <span className="font-medium text-foreground dark:text-white">{athlete.club.name}</span>
                    </TableCell>
                    <TableCell>
                    ...
                    <TableCell>
                      <div className="text-sm">
                        {athlete.phone && <div className="text-foreground dark:text-white">{athlete.phone}</div>}
                        {athlete.email && <div className="text-muted-foreground dark:text-muted-foreground">{athlete.email}</div>}
                      </div>
                    </TableCell>
                    <TableCell>
            ...
            {athletes.length === 0 && (
              <div className="text-center py-12 animate-fade-in">
                <div className="bg-muted/50 rounded-2xl p-8 mx-6">
                  <User className="h-16 w-16 text-muted-foreground dark:text-muted-foreground mx-auto mb-4" />
                  <p className="text-muted-foreground dark:text-muted-foreground text-lg mb-4">Aucun athlète enregistré</p>
                  <Button 
                    className="bg-gradient-to-r from-[#d62027] to-[#b91c1c] hover:from-[#b91c1c] hover:to-[#991b1b] text-white shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300"
                    onClick={() => {
                      setEditingAthlete(null)
