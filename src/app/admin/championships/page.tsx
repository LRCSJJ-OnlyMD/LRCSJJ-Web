...
export default function ChampionshipsManagement() {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      case 'upcoming': return 'bg-primary/10 text-primary-foreground'
      case 'ongoing': return 'bg-accent/10 text-accent-foreground'
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4 border-b pb-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-2xl font-semibold text-foreground">{selectedChampionship.name}</h3>
                    <p className="text-muted-foreground mt-1">{selectedChampionship.season.name}</p>
                ...
                {selectedChampionship.description && (
                  <div>
                    ...
                    <p className="text-foreground leading-relaxed">{selectedChampionship.description}</p>
                  </div>
                )}
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div>
                    <h4 className="font-semibold text-foreground mb-3">Informations de l&apos;Événement</h4>
                ...
                <div>
                  <h4 className="font-semibold text-foreground mb-3">Durée de l&apos;Événement</h4>
                  <div className="bg-gray-50 rounded-lg p-4">
          ...
          <TabsContent value="overview">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold text-accent">{stats.ongoing}</div>
                </CardContent>
              </Card>
              ...
              <CardContent>
                        ...
                        <TableRow key={championship.id}>
                          <TableCell>
                            <div>
                              ...
                              {championship.description && (
                                <div className="text-sm text-muted-foreground line-clamp-2">{championship.description}</div>
                              )}
                            </div>
                          </TableCell>
                          <TableCell>
                          ...
                          <TableCell>
                            <div className="text-sm">
                              ...
                              <div className="text-muted-foreground">au {new Date(championship.endDate).toLocaleDateString('fr-FR')}</div>
                            </div>
                          </TableCell>
                ...
                {championships.length === 0 && (
                  <div className="text-center py-8">
                    <p className="text-muted-foreground">Aucun championnat organisé</p>
                    <Button 
