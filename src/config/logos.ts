...
export const LOGO_PATHS = {
  ...
  federation: {
    ...
    // North African Union logo (UNAJJ)
    northAfrica: "/logos/federation/unajj-logo.png",
    // African Union logo (JJAU)
    africa: "/logos/federation/jjau-logo.png",
...
export const CLOUDINARY_CONFIG = {
  ...
  uploadPreset:
    process.env.NEXT_PUBLIC_CLOUDINARY_UPLOAD_PRESET || "lrcsjj-uploads",
...
export const LOGO_GUIDELINES = {
  ...
  usage: {
    leagueMain:
      "Primary branding in headers, landing pages, official documents",
