...
function SidebarNav({ className }: { className?: string }) {
  ...
  const navigation: NavItem[] = [
    ...
    {
      title: "Posts & Réalisations",
      icon: Medal,
      children: [
        { title: "Gérer les Posts", href: "/admin/posts", icon: FileText },
        { title: "Voir les Posts", href: "/posts", icon: Medal },
      ],
    },
    {
...
export function Sidebar({ className }: SidebarProps) {
  return (
    <div
      className={cn(
        "hidden border-r bg-card border-border lg:block lg:w-64",
        className
      )}
    >
      <SidebarNav />
